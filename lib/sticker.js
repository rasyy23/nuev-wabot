...
function sticker6(img, url) {
  return new Promise(async (resolve, reject) => {
    ...
    const ffmpegPath = path.join(currentDir, 'lib/static_ffmpeg/ffmpeg');
    const ffprobePath = path.join(currentDir, 'lib/static_ffmpeg/ffprobe');
    const flvtoolPath = path.join(currentDir, 'lib/static_ffmpeg/flvtool');
